...
import * as sty from "./PlasmicTextInput.module.css" // plasmic-import: xGJADBXpQ5tshn/css
import Searchsvg2Icon from "./icons/PlasmicIcon__Searchsvg2" // plasmic-import: Hw61fsbcV27xWT/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg" // plasmic-import: esFlDI1NFt3Npn/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Searchsvg2Icon
                className={classNames(projectcss.all, sty.svg__iziX4)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__pcyMl)}
                role={"img"}
              />
            ),
